...
namespace RaskTrip.DataAccess
{
    ...
    public partial class PushTimeTicketProperty
    {
        ...
        public virtual PushTimeTicket PushTimeTicket { get; set; }
        public virtual TimeTicketProperty TimeTicketProperty { get; set; }
